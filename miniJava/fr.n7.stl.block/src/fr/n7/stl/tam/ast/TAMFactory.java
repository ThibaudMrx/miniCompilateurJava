...
public interface TAMFactory {
	...
	/**
	 * Build a TAM string constant Load instruction AST node.
	 * @param _value Value of the string constant that is copied on the stack.
	 * @return A TAM string constant Load instruction AST node.
	 */
	/*
	...
	*/
	...
	public static TAMInstruction createUnaryOperator(UnaryOperator _operator) {
		...
		case Malloc : return Library.MAlloc;
		case PrintInt : return Library.IOut;
		case PrintChar : return Library.COut;
		case PrintStr : return Library.SOut;
		case PrintBool : return Library.BOut;
		default: return null;
		}
	}
